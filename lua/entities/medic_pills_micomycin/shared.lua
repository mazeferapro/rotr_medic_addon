...
function ENT:Use(ply)
	ply:SetNWInt("MedicineModfungendocarditis", 100)
	ply:SetNWInt("MedicineModfollicularistonsilitis", 100)
	ply:SetNWInt("MedicineModnecroticpoliangiit", 100)
