...
function ENT:Draw()
	...
	cam.Start3D2D(Pos + Ang:Up() * 4.2 + Ang:Right() * -1.8 + Ang:Forward() * -3.9, Ang, 0.05)
        draw.DrawText("RAPID FLU TESTS", "Medicinefont4", 11, -52, White, TEXT_ALIGN_LEFT, TEXT_ALIGN_LEFT)
	cam.End3D2D()
	...
	cam.Start3D2D(Pos + Ang:Up() * 4.2 + Ang:Right() * 1.2 + Ang:Forward() * -4.7, Ang, 0.06)
		...
		surface.SetMaterial(Material("pills/flu_tests.png"))
		surface.DrawTexturedRect(10,-80,150,150)
	cam.End3D2D()
